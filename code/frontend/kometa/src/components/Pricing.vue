      ...
      <div class="grid max-w-md gap-10 row-gap-5 sm:row-gap-10 lg:max-w-screen-md lg:grid-cols-2 sm:mx-auto">
            ...
            <div>
              ...
              <ul class="space-y-2">
                <li class="flex items-center">
                  ...
                  <p class="font-medium text-gray-800">10 Credits upon signup</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-2">
                    <svg class="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
                  ...
                  <p class="font-medium text-gray-800">10 Extra credits for valuable feedback</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-2">
                    <svg class="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
                  ...
                  <p class="font-medium text-gray-800">Access to idea generation</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-2">
                    <svg class="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
                  ...
                  <p class="font-medium text-gray-800">Access to idea details and quality</p>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="flex flex-col justify-between p-5 bg-white border rounded shadow-sm">
          <div class="mb-6">
            <div class="flex items-center justify-between pb-6 mb-6 border-b">
              <div>
                ...
                <p class="text-5xl font-extrabold">$5.99</p>
              </div>
            ...
            <div>
              ...
              <ul class="space-y-2">
                <li class="flex items-center">
                  ...
                  <p class="font-medium text-gray-800">20 Additional credits</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-2">
                    <svg class="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
                  ...
                  <p class="font-medium text-gray-800">Access to plans</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-2">
                    <svg class="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
                  ...
                  <p class="font-medium text-gray-800">Exporting your ideas to file</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-2">
                    <svg class="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
          ...
          <div>
            <a
              href="/login"
              class="inline-flex items-center justify-center w-full h-12 px-6 mb-4 font-medium tracking-wide text-white transition duration-200 bg-weather-primary rounded shadow-md hover:bg-gray-900 focus:shadow-outline focus:outline-none pointer-events-none cursor-not-allowed"
            >
              Pay with Stripe (Coming soon)
            </a>
            <p class="text-sm text-gray-600">
              Why charge? I am solo builder without any funding. I have to pay the hosting and OpenAI bills somehow.
            </p>
          </div>
        </div>
      </div>
