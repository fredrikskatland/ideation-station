    ...
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div class="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <h6 class="mb-2 font-semibold leading-5">Developers</h6>
          <p class="mb-3 text-sm text-gray-900">
            You have the tech skills to build, want to speed up the planning process.
          </p>
        ...
        <div>
          ...
          <h6 class="mb-2 font-semibold leading-5">Business savy</h6>
          <p class="mb-3 text-sm text-gray-900">
            You know the business side of things, and want to speed up or validate your analysis.
          </p>
          <ul class="mb-4 -ml-1 space-y-2">
            <li class="flex items-start">
              <span class="mr-1">
        ...
        <div>
          ...
          <h6 class="mb-2 font-semibold leading-5">Creative</h6>
          <p class="mb-3 text-sm text-gray-900">
            You have a ton of ideas, and want to see what it takes to bring them to life.
          </p>
          <ul class="mb-4 -ml-1 space-y-2">
            <li class="flex items-start">
              <span class="mr-1">
        ...
        <div>
          ...
          <h6 class="mb-2 font-semibold leading-5">Clueless</h6>
          <p class="mb-3 text-sm text-gray-900">
            You have no idea what to do and want inspiration.
          </p>
          <ul class="mb-4 -ml-1 space-y-2">
            <li class="flex items-start">
              <span class="mr-1">
